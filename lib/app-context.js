...
var AppContext = (function () {
  ...
  _createClass(AppContext, [{
    key: 'transitionTo',
    value: function transitionTo(level) {
      var _this = this;
    ...
    value: function loadFromPackage() {
      var filename = this.getAppContextFilenameFromPackage();
      if (filename == null) {
        throw new Error('Your package.json does not define an "app-context".');
      }
    ...
    value: function load( /* optional */filename) {
      ...
      if (this.getAppContextFilenameFromPackage()) {
        return this.loadFromPackage();
      }
      return this.loadFromFile(_path2['default'].join(process.cwd(), 'app-context'));
    }
  }]);
